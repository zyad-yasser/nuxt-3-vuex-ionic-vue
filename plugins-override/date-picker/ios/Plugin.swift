...
public class DatePickerPlugin: CAPPlugin {
    ...
    private func loadOptions() {
        ...
        self.defaultPickerTheme = bridge.config.getString(self.CONFIG_KEY_PREFIX + "theme") ?? self.defaultPickerTheme
        self.defaultPickerMode = bridge.config.getString(self.CONFIG_KEY_PREFIX + "mode") ?? self.defaultPickerMode
        self.defaultPickerFormat = bridge.config.getString(self.CONFIG_KEY_PREFIX + "format") ?? self.defaultPickerFormat
        self.defaultPickerTimezone = bridge.config.getString(self.CONFIG_KEY_PREFIX + "timezone") ?? self.defaultPickerTimezone
        self.defaultPickerLocale = bridge.config.getString(self.CONFIG_KEY_PREFIX + "locale") ?? self.defaultPickerLocale
        self.defaultPickerCancelText = bridge.config.getString(self.CONFIG_KEY_PREFIX + "cancelText") ?? self.defaultPickerCancelText
        self.defaultPickerDoneText = bridge.config.getString(self.CONFIG_KEY_PREFIX + "doneText") ?? self.defaultPickerDoneText
        self.defaultPicker24h = bridge.config.getValue(self.CONFIG_KEY_PREFIX + "is24h") as? Bool ?? self.defaultPicker24h
        self.defaultPickerTitle = bridge.config.getString(self.CONFIG_KEY_PREFIX + "title") ?? self.defaultPickerTitle
        self.defaultPickerTitleFontColor = bridge.config.getString(self.CONFIG_KEY_PREFIX + "titleFontColor") ?? self.defaultPickerTitleFontColor
        self.defaultPickerTitleBgColor = bridge.config.getString(self.CONFIG_KEY_PREFIX + "titleBgColor") ?? self.defaultPickerTitleBgColor
        self.defaultPickerBgColor = bridge.config.getString(self.CONFIG_KEY_PREFIX + "bgColor") ?? self.defaultPickerBgColor
        self.defaultPickerFontColor = bridge.config.getString(self.CONFIG_KEY_PREFIX + "fontColor") ?? self.defaultPickerFontColor
        self.defaultPickerButtonBgColor = bridge.config.getString(self.CONFIG_KEY_PREFIX + "buttonBgColor") ?? self.defaultPickerButtonBgColor
        self.defaultPickerButtonFontColor = bridge.config.getString(self.CONFIG_KEY_PREFIX + "buttonFontColor") ?? self.defaultPickerButtonFontColor
        self.defaultPickerMergedDateAndTime = bridge.config.getValue(self.CONFIG_KEY_PREFIX + "mergedDateAndTime") as? Bool ?? self.defaultPickerMergedDateAndTime
    }
    ...
    private func loadCallOptions() {
        ...
        self.alertSize = CGSize(width: bridge.viewController!.view.bounds.size.width, height: 250 + self.defaultButtonHeight + self.defaultPaddingHeight)
    ...
    private func createPickerView() {
        ...
        let width = bridge.viewController!.view.bounds.size.width
        let height = bridge.viewController!.view.bounds.size.height
    ...
    private func dismiss() {
        ...
        DispatchQueue.main.async {
            ...
            UIView.transition(with: bridge.viewController!.view, duration: 0.25, options: [.curveEaseIn], animations: {
            }, completion: nil)
        }
    }
    ...
    @objc func present(_ call: CAPPluginCall) {
        DispatchQueue.main.async {
            ...
            let x = bridge.viewController!.view.bounds.size.width
            let y = bridge.viewController!.view.bounds.size.height
            ...
            bridge.viewController!.view.addSubview(self.backgroundView!)
